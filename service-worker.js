/*
References:
https://web.dev/offline-fallback-page/#the-offline-fallback-page
...
self.addEventListener("activate", (event) => {
  ...
  event.waitUntil(
    (async () => {
      ...
      if ("navigationPreload" in selfRegistration) {
        await selfRegistration.navigationPreload.enable();
      }
    })()
  );
    ...
    event.respondWith(
      (async () => {
        try {
          ...
          const networkResponse = await fetch(eventRequest);
